class AddCachedVotesToComments < ActiveRecord::Migration
  def self.up
    ...
    Shop.find_each(&:update_cached_votes)
  ...
  def self.down
    ...
    remove_column :shops, :cached_votes_total
    remove_column :shops, :cached_votes_score
    remove_column :shops, :cached_votes_up
    remove_column :shops, :cached_votes_down
    remove_column :shops, :cached_weighted_score
    remove_column :shops, :cached_weighted_total
    remove_column :shops, :cached_weighted_average
  end
end
